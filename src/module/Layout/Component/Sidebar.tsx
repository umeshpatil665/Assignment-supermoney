...
const {pathname}=useLocation()
  return (
    <div
      className={cn(
        "relative h-full tran duration-300 ease-linear translate-x-0 flex flex-col ",
        {
    ...
    >
      ...
      <div
        className={cn(
          "w-full h-[60px] flex items-center justify-between space-x-2",
  ...
  <Link
    to={cur?.path}
    className={cn("flex items-center gap-2", { "flex-col gap-0": sidebarClose })}
  >
